...
class CourseTest(unittest.TestCase):
    __default_teacher = Teacher('Ivan Kuruch')
    __default_course = Course('Intro to Java', __default_teacher)

    def test_constructor(self):
        self.assertEqual('Intro to Java', self.__default_course.name)
    ...
    def test_teacher_validation(self):
        with self.assertRaises(TypeError):
            self.__default_course.teacher = 'Ivan Kuruch but a string'

    def test_add_topic(self):
        course = Course('Intro to Java', self.__default_teacher)
    ...
    def test_str(self):
        ...
        course.add_topic('What is JVM')
        self.assertEqual(
            'Course: Name=Intro to Java; Teacher=Teacher: Name=Ivan Kuruch; Topics=[\'What is JVM\']',
            str(course)
        )
